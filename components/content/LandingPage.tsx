            ...
            <div className="content">
                <div className="flex justify-between items-center gap-20 w-full">
                    <div className={`flex flex-col gap-5 `}>
                        ...
                        <h1 className={`text-white text-title ${inter.className}`}>A sleepless <span className="text-primary">Frontend Developer</span> specializing in JavaScript frameworks.</h1>
